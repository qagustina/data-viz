...
def get_datadir():
    return '/mnt/ypy3_5/land/gldas/data/2022/'
...
def plot_gif_reg():
    ...
    for file_path in file_paths:
        ...
        for i, hour in enumerate(hours_data):
            ...
            plt.savefig(image_name,  bbox_inches='tight') # add bbox_inches
    ...
    images[0].save('sm_hh_day.gif', save_all=True, append_images=images[1:], duration=500, loop=0)
